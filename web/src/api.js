...
export const facilityAPI = {
  ...
  getSiteShareSuggestions: () => apiFetch(`${BASE}/roster/site-share-suggestions`, { headers: facilityHeaders() }),
  applySiteShares: (changes) => apiFetch(`${BASE}/roster/site-shares/apply`, { method: 'POST', headers: facilityHeaders(), body: JSON.stringify({ changes }) }),
  ...
  logFlagResolution: (flagType, action) => apiFetch(`${BASE}/schedule/flags/resolution`, { method: 'POST', headers: facilityHeaders(), body: JSON.stringify({ flagType, action }) }),
  setFlagRule: (flagType, enabled) => apiFetch(`${BASE}/schedule/flags/rules`, { method: 'POST', headers: facilityHeaders(), body: JSON.stringify({ flagType, enabled }) }),
  getAllocation: (year, month) => apiFetch(`${BASE}/schedule/allocation?year=${year}&month=${month}`, { headers: facilityHeaders() }),
  applyAllocationTarget: (rosterEntryId, location, pct) => apiFetch(`${BASE}/schedule/allocation/apply`, { method: 'POST', headers: facilityHeaders(), body: JSON.stringify({ rosterEntryId, location, pct }) }),
