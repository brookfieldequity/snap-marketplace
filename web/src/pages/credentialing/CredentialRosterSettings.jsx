...
export default function CredentialRosterSettings() {
  return (
    <div style={{ padding: '32px 40px', maxWidth: 760, margin: '0 auto' }}>
      <h1 style={{ fontSize: 24, fontWeight: 800, color: '#10233F', margin: '0 0 4px' }}>Roster</h1>
      ...
      <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #DCE8F7', padding: '24px 28px' }}>
        <div style={{ fontSize: 15, fontWeight: 800, color: '#10233F', marginBottom: 10 }}>
        ...
        <div style={{ background: '#F8FAFC', border: '1px solid #DCE8F7', borderRadius: 10, padding: '12px 16px', fontSize: 13, color: '#64748B' }}>
