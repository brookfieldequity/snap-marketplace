...
const styles = {
  ...
  primaryBtn: { padding: '10px 20px', background: 'linear-gradient(135deg, #2563EB, #3B82F6)', boxShadow: '0 2px 10px rgba(37,99,235,0.3)', color: '#fff', border: 'none', borderRadius: 8, fontWeight: 600, cursor: 'pointer', fontSize: 14, whiteSpace: 'nowrap' },
  ...
  card: { background: '#fff', border: '1px solid #DCE8F7', borderRadius: 12, padding: 20 },
  ...
  gridWrap: { background: '#fff', border: '1px solid #DCE8F7', borderRadius: 12, overflow: 'hidden', marginBottom: 16 },
  grid: { width: '100%', borderCollapse: 'collapse' },
  gridTh: { padding: '12px 8px', fontSize: 12, fontWeight: 700, color: '#64748B', textTransform: 'uppercase', letterSpacing: 0.5, background: '#F8FAFC', borderBottom: '1px solid #DCE8F7', textAlign: 'center' },
  gridLocCell: { padding: '10px 16px', fontSize: 14, fontWeight: 500, color: '#1E293B', borderBottom: '1px solid #EAF1FA' },
  gridCell: { padding: 6, textAlign: 'center', borderBottom: '1px solid #EAF1FA' },
  stepperInput: { width: 56, padding: '6px 4px', textAlign: 'center', border: '1px solid #DCE8F7', borderRadius: 6, fontSize: 14, fontWeight: 600, color: '#1E293B', outline: 'none' },
  coverageSelect: { width: 110, padding: '6px 8px', border: '1px solid #DCE8F7', borderRadius: 6, fontSize: 13, fontWeight: 600, color: '#1E293B', background: '#fff', outline: 'none', cursor: 'pointer' },
