...
const styles = {
  ...
  primaryBtn: { padding: '10px 20px', background: '#6366F1', color: '#fff', border: 'none', borderRadius: 8, fontWeight: 600, cursor: 'pointer', fontSize: 14, whiteSpace: 'nowrap' },
  ...
  backLink: { background: 'none', border: 'none', color: '#6366F1', fontSize: 14, fontWeight: 600, cursor: 'pointer', padding: 0, marginBottom: 16 },
  ...
  defaultBadge: { fontSize: 11, fontWeight: 600, color: '#7C3AED', background: '#EDE9FE', padding: '2px 8px', borderRadius: 999 },
