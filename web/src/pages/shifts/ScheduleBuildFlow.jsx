...
const styles = {
  ...
  headerEyebrow: { fontSize: 11, fontWeight: 700, color: '#2563EB', textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 4 },
  ...
  spinner: { fontSize: 48, color: '#2563EB', animation: 'spin 1.5s linear infinite' /* note: actual spin requires keyframes */ },
