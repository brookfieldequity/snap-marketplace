...
- A section description and a field label must be the application's OWN words to the applicant (or empty). NEVER copy an instruction from these rules — "capture once", "repeats identical blocks", "do not emit", etc. — into any description or label. Those are directions to you, not text that belongs on the form.
