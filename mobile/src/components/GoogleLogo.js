...
// The official Google "G" mark, from Google's own sign-in button assets
// (brand guidelines require the real four-color artwork, not a styled
// letter — same principle as the native Apple button, App Review 8/4).
// Path data is Google's published 18x18 button asset, unmodified.
